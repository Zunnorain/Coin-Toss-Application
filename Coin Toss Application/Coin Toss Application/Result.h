...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Tempus Sans ITC", 48, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label1->ForeColor = System::Drawing::Color::FloralWhite;
			this->label1->Location = System::Drawing::Point(57, 101);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(279, 104);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Heads!";
			this->label1->Click += gcnew System::EventHandler(this, &Result::label1_Click);
			// 
			// progressBar1
			// 
			this->progressBar1->Location = System::Drawing::Point(95, 222);
			this->progressBar1->Name = L"progressBar1";
			this->progressBar1->Size = System::Drawing::Size(172, 23);
			this->progressBar1->TabIndex = 3;
			this->progressBar1->Click += gcnew System::EventHandler(this, &Result::progressBar1_Click);
			// 
			// timer1
			// 
			...
			this->ClientSize = System::Drawing::Size(367, 308);
